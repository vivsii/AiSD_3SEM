...
int map[V][V] = { { INT_MAX, 25, 40, 31, 27, 12, 21, 23},
        { 5, INT_MAX, 17, 30, 25, 4, 6, 7},
        { 19, 15, INT_MAX, 6, 1,5,7, 9},
        { 9, 50, 24, INT_MAX, 6 , 4, 6,7},
        { 22, 8, 7, 10, INT_MAX ,4,6,2}, 
        {11, 22, 8, 7, 10, INT_MAX ,4,6}, 
        {10,4,22, 8, 7, 10, INT_MAX ,4}};
struct individual {
  string gnome;
  int fitness;
};
